...
def hashtype():
	logo1()
	print(color.YELLOW+"|-------Hashes-------|")
	print (B + '\n[' + P + '1' + B + '] ' + P + GR + 'MD5')
	print(B + '[' + P + '2' + B + '] ' + P + GR + 'SHA1')
	print(B + '[' + P + '3' + B + '] ' + P + GR +'SHA224')
	print(B + '[' + P + '4' + B + '] ' + P + GR + 'SHA256')
	print(B + '[' + P + '5' + B + '] ' + P + GR + 'SHA384')
	print(B + '[' + P + '6' + B + '] ' + P + GR + 'SHA512')
	print(B + '[' + P + '7' + B + '] ' + P + GR + 'All')
	print(B + '[' + P + '0' + B + '] ' + P + GR + 'Exit')
	hhtype = input(B + '\n[' + P + '*' + B + '] ' + GR)
	if hhtype == "1":
		htype = 'md5'
		start(htype)
...
def logo1():
 ...
 _____                              _    
|_   _|                            | |   
  | |_ ____  __  ___ _ __ __ _  ___| | __
  | | '__\ \/ / / __| '__/ _` |/ __| |/ /
  | | |   >  < | (__| | | (_| | (__|   < 
  \_/_|  /_/\_(_)___|_|  \__,_|\___|_|\_\
    ...
    print(color.LIGHTWHITE_EX+'''
              +      (luca)      +
        | Developer:Amirhosine         |
        | Email:luca.wq33@gmail.com    |
        | GitHub:Luca-Sec33            | 
        --------------------------------
		  ''')
def quiting():
